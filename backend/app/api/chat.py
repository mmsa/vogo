...
async def chat(
    ...
    user_memberships = (
        db.query(UserMembership).filter(UserMembership.user_id == current_user.id).all()
    )
...
async def hello(
    ...
    benefits_count = (
        db.query(Benefit)
        .join(UserMembership, Benefit.membership_id == UserMembership.membership_id)
        .filter(
    ...
    if user_memberships == 0:
        message = "👋 Hi! I'm your vogoplus.app assistant. Add your memberships and I'll help you discover and use all your benefits!"
