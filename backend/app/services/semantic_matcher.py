...
async def generate_user_message(
    ...
    prompt = f"""You're VogPlus.ai assistant. User is browsing a website and you found relevant benefits they ALREADY HAVE.
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are VogPlus.ai benefits assistant. Be concise and helpful.",
                },
