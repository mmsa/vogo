  ...
  <div class="wrap">
    <div class="header">
      <div class="header-top">
        <div class="logo">💎 VogPlus</div>
        <div class="domain-chip" id="domain">—</div>
      </div>
...
function updateHeaderWithUser() {
  ...
  if (currentUser && subtitle) {
    ...
    subtitle.innerHTML = `👤 <span style="font-weight: 600;">${name}</span> • Smart perks. Zero effort.`;
  }
}
...
async function loadRecommendations() {
  try {
    console.log("🔍 Loading recommendations for:", currentHostname);
  ...
  content.innerHTML = `
    <div class="results">
      <div class="results-header">
        <h3>💰 ${recs.length} Way${recs.length > 1 ? "s" : ""} to Save</h3>
